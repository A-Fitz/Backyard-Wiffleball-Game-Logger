...
public class Alltime_Stats {
    ...
    public Alltime_Stats(Integer team_id, Integer wins, Integer losses, Integer ties, Integer h_runs, Integer h_strikeouts, Integer h_fieldouts, Integer h_walks, Integer h_singles, Integer h_doubles, Integer h_triples, Integer h_homeruns, Integer p_runs, Integer p_strikeouts, Integer p_fieldouts, Integer p_walks, Integer p_singles, Integer p_doubles, Integer p_triples, Integer p_homeruns) {
        this.team_id = team_id;
        this.wins = wins;
        this.losses = losses;
        this.ties = ties;
    ...
    public boolean equals(Object o) {
        ...
        Alltime_Stats that = (Alltime_Stats) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, team_id, wins, losses, ties, h_runs, h_strikeouts, h_fieldouts, h_walks, h_singles, h_doubles, h_triples, h_homeruns, p_runs, p_strikeouts, p_fieldouts, p_walks, p_singles, p_doubles, p_triples, p_homeruns);
    }
